import { isUri } from '../src/parse-siwe.js';
...
describe('test IPv6 addresses', () => {
  test('IPv6address no double colon', () => {
    ...
    result = isUri('uri://[ffff:abcd:0:10:200:3000:f8a]');
    expect(result).toBe(false);
    // too many 16-bit digits
    result = isUri('uri://[ffff:abcd:0:10:200:3000:ff:255.255.255.255]');
    expect(result).toBe(false);
    // too few 16-bit digits
    result = isUri('uri://[ffff:abcd:0:10:200:255.255.255.255]');
    expect(result).toBe(false);
  });
  test('IPv6address leading double colon WITHOUT IPv4', () => {
    result = isUri('uri://[::]');
    expect(result.host).toBe('::');
    result = isUri('uri://[::ffff]');
    expect(result.host).toBe('::ffff');
    result = isUri('uri://[::1:2:3:4:5:6:7]');
    expect(result.host).toBe('::1:2:3:4:5:6:7');
    // too many 16-bit digits
    result = isUri('uri://[::1:2:3:4:5:6:7:8]');
    expect(result).toBe(false);
  });
  test('IPv6address leading double colon WITH IPv4', () => {
    result = isUri('uri://[::198.162.10.255]');
    expect(result.host).toBe('::198.162.10.255');
    result = isUri('uri://[::ffff:198.162.10.255]');
    expect(result.host).toBe('::ffff:198.162.10.255');
    result = isUri('uri://[::1:2:3:4:5:198.162.10.255]');
    expect(result.host).toBe('::1:2:3:4:5:198.162.10.255');
    // too many 16-bit digits
    result = isUri('uri://[::1:2:3:4:5:6:198.162.10.255]');
    expect(result).toBe(false);
  });
  ...
  test('IPv6address trailing double colon WITH IPv4', () => {
    result = isUri('uri://[1::198.162.10.255]');
  ...
  test('IPv6address leading & trailing double colon WITHOUT IPv4', () => {
    result = isUri('uri://[1::2]');
    expect(result.host).toBe('1::2');
    result = isUri('uri://[1:2:3:4:5:6::7]');
    expect(result.host).toBe('1:2:3:4:5:6::7');
    result = isUri('uri://[ffff:aaaa:bbbb::cccc:dddd:eeee:9999]');
  ...
  test('IPv6address leading & trailing double colon WITH IPv4', () => {
    result = isUri('uri://[1::2:198.162.10.255]');
    expect(result.host).toBe('1::2:198.162.10.255');
    result = isUri('uri://[1:2:3:4::7:198.162.10.255]');
    expect(result.host).toBe('1:2:3:4::7:198.162.10.255');
    result = isUri('uri://[ffff:aaaa:bbbb::cccc:dddd:198.162.10.255]');
